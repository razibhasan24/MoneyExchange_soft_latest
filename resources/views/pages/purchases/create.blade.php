...
<div class="container">
    ...
    <div class="container my-4 bg-white p-4 shadow rounded" style="margin-top:0 !important;">
        ...
        <h3 class="mb-3 text-center text-3x2 font-bold"
            style="margin-bottom: 60px !important; background-color: rgba(221, 224, 221, 1); color: black; padding: 15px 245px; border-radius:0 40px 40px 0; display: inline-block;">
            Create Purchase
        </h3>
        <!-- Master Fields -->
        <div class="row mb-3">
        ...
        <!-- Item Fields -->
        <h3 class="mb-3 text-center text-3x2 font-bold"
            style="margin-bottom: 60px !important; background-color: rgba(221, 224, 221, 1); color: black; padding: 15px 280px; border-radius:0 40px 40px 0; display: inline-block;;">
            Add Items
        </h3>
        <div class="row mb-3" style="margin-bottom: 2rem !important;">
            <div class="col-md-3">
                <label class="form-label">Currency</label>
                <select id="item_description" class="form-control">
    ...
    <script>
        ...
        document.getElementById('addItemBtn').addEventListener('click', function() {
            const itemEl=document.getElementById('item_description');
            const itemId = itemEl.value;
            const itemName=itemEl.options[itemEl.selectedIndex].text;
