...
@section('pages')
   <div class="container">
    ...
    <div class="container my-4 bg-white p-4 shadow rounded" style="margin-top:0 !important;">
        ...
        <!-- Item Fields -->
        <h3 class="mb-3 text-center text-3x2 font-bold" style="margin-bottom:20px !important;">Add Items</h3>
        <div class="row mb-3">
            <div class="col-md-3">
            ...
            <div class="col-md-2 d-flex align-items-end">
                <button id="addItemBtn" class="btn btn-success w-100">Add Item</button>
            </div>
        </div>
